...
namespace GHIElectronics.TinyCLR.Data.GpsParser
{
    public class GpsDevice
    {
        ...
        public GpsDevice(string UartPort, int BaudRate=4800)
        {
        ...
        public void StartGPS()
        {
            ...
            serialPort = new CommunicationsBus(UartPort, BaudRate);
            gpsShield = new Reader(serialPort, 100, 0.0);
        ...
        {
            WriteLine("time: " + gpsPoint.Timestamp + "Lat/Lng: " + gpsPoint.Latitude + "/" + gpsPoint.Longitude);
            //Lcd.Clear();
    ...
    public class Reader
    {
        ...
        private readonly CommunicationsBus _serialPort;
        ...
        public Reader(CommunicationsBus serialPort)
            : this(serialPort, 100, 0.0)
        {

        }
        public Reader(CommunicationsBus serialPort, int timeOutBetweenReadsInMilliseconds, double minDistanceInMilesBetweenPoints)
        {
        ...
        private void _serialPort_DataReceived(string Data)
        {
            try
            {
                ProcessBytes(Data);
